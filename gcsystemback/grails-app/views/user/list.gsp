			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="secondLastName" title="${message(code: 'user.secondLastName.label', default: 'Second Last Name')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${userInstance.id}">${fieldValue(bean: userInstance, field: "secondLastName")}</g:link></td>
