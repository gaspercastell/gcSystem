	...
	<body>
		...
		<div id="show-user" class="content scaffold-show" role="main">
			...
			<ol class="property-list user">
				...
				<g:if test="${userInstance?.secondLastName}">
				<li class="fieldcontain">
					<span id="secondLastName-label" class="property-label"><g:message code="user.secondLastName.label" default="Second Last Name" /></span>
					
						<span class="property-value" aria-labelledby="secondLastName-label"><g:fieldValue bean="${userInstance}" field="secondLastName"/></span>
